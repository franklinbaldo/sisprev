...
| unidade                                                                                                           | origens legadas            | tipo_calculo (projeção legada) | estado_auditoria | estado_implantacao            |
| ----------------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------------ | ---------------- | ----------------------------- |
| [`invalidez-cf88-original-acidente-em-servico`](invalidez-cf88-original-acidente-em-servico.md)                   | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-cf88-original-doenca-catalogada`](invalidez-cf88-original-doenca-catalogada.md)                       | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-cf88-original-lce1-causa-comum`](invalidez-cf88-original-lce1-causa-comum.md)                         | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-cf88-original-lce39-feminino-causa-comum`](invalidez-cf88-original-lce39-feminino-causa-comum.md)     | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-cf88-original-lce39-masculino-causa-comum`](invalidez-cf88-original-lce39-masculino-causa-comum.md)   | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-cf88-original-lce68-causa-comum`](invalidez-cf88-original-lce68-causa-comum.md)                       | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `elaboracao`     | `pendente_mapeamento_sisprev` |
| [`invalidez-cf88-original-molestia-profissional`](invalidez-cf88-original-molestia-profissional.md)               | `regra-0001`, `regra-0002` | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec20-acidente-em-servico`](invalidez-ec20-acidente-em-servico.md)                                     | `regra-0004`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec20-causa-comum`](invalidez-ec20-causa-comum.md)                                                     | `regra-0004`               | `Valor Efetivo`                | `elaboracao`     | `confirmada_com_ressalva`     |
| [`invalidez-ec20-doenca-catalogada`](invalidez-ec20-doenca-catalogada.md)                                         | `regra-0004`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec20-molestia-profissional`](invalidez-ec20-molestia-profissional.md)                                 | `regra-0004`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-acidente-em-servico`](invalidez-ec41-geral-acidente-em-servico.md)                         | `regra-0006`               | `Valor Médio`                  | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-causa-comum`](invalidez-ec41-geral-causa-comum.md)                                         | `regra-0007`               | `Proporcionalidade Dias`       | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-doenca-catalogada`](invalidez-ec41-geral-doenca-catalogada.md)                             | `regra-0006`               | `Valor Médio`                  | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-media-lc228-causa-comum`](invalidez-ec41-geral-media-lc228-causa-comum.md)                 | `regra-0007`               | `Valor Médio`                  | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-molestia-profissional`](invalidez-ec41-geral-molestia-profissional.md)                     | `regra-0006`               | `Valor Médio`                  | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-pre-mp167-acidente-em-servico`](invalidez-ec41-geral-pre-mp167-acidente-em-servico.md)     | `regra-0006`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-pre-mp167-causa-comum`](invalidez-ec41-geral-pre-mp167-causa-comum.md)                     | `regra-0007`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-pre-mp167-doenca-catalogada`](invalidez-ec41-geral-pre-mp167-doenca-catalogada.md)         | `regra-0006`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec41-geral-pre-mp167-molestia-profissional`](invalidez-ec41-geral-pre-mp167-molestia-profissional.md) | `regra-0006`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec70-art-6a-acidente-em-servico`](invalidez-ec70-art-6a-acidente-em-servico.md)                       | `regra-0008`               | `Valor Efetivo`                | `elaboracao`     | `confirmada_com_ressalva`     |
| [`invalidez-ec70-art-6a-causa-comum`](invalidez-ec70-art-6a-causa-comum.md)                                       | `regra-0009`               | `Proporcionalidade Dias`       | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec70-art-6a-doenca-catalogada`](invalidez-ec70-art-6a-doenca-catalogada.md)                           | `regra-0008`               | `Valor Efetivo`                | `elaboracao`     | `confirmada_com_ressalva`     |
| [`invalidez-ec70-art-6a-lc228-causa-comum`](invalidez-ec70-art-6a-lc228-causa-comum.md)                           | `regra-0009`               | `Valor Efetivo`                | `concluida`      | `confirmada_com_ressalva`     |
| [`invalidez-ec70-art-6a-molestia-profissional`](invalidez-ec70-art-6a-molestia-profissional.md)                   | `regra-0008`               | `Valor Efetivo`                | `elaboracao`     | `confirmada_com_ressalva`     |
