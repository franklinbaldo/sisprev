...
## Bloco A — três origens para oito destinos

`regra-0001`, `regra-0002` e `regra-0004` são substituídas por:

- quatro unidades da CF/88 original, uma por classe de causa; e
- quatro unidades da EC 20/1998, uma por classe de causa.

## Bloco B — quatro origens para quatorze destinos

`regra-0006` e `regra-0007` são substituídas por nove unidades da regra geral da
EC 41:

- quatro no segmento de 31/12/2003 a 19/02/2004;
- três causas qualificadas com média desde 20/02/2004;
- uma causa comum com média federal e fração anual da LC 228 até 12/03/2008; e
- uma causa comum com média limitada e fração em dias da LCE 432 desde
  13/03/2008.

`regra-0008` e `regra-0009` são substituídas por cinco unidades do art. 6º-A:

- três causas qualificadas com remuneração do cargo e paridade;
...
- EC 41/2003 e art. 6º-A preservado: `[31/12/2003, 01/01/2025)`.
- LCE 1.100/2021: desde `18/10/2021`, subordinada à precedência do art. 4º da
  ECE 146/2021 quando houver direito anterior formado até 31/12/2024.

## Fronteiras internas do Bloco B

- `[31/12/2003, 20/02/2004)`: LC 228 e remuneração do cargo.
- `[20/02/2004, 13/03/2008)`: média federal; a causa comum mantém a fração anual
  da LC 228.
- desde `13/03/2008`: LCE 432; a causa comum usa fração em dias depois dos
  limites do art. 45.

## Coortes do Bloco C

- ingresso até `31/12/2003`: paridade;
- ingresso desde `01/01/2004`: reajuste sem paridade.

As fronteiras são contínuas. `DATA_DIREITO_ATE` é exclusivo; os demais marcos
mencionados como início são inclusivos.

# Sobreposições intencionais e precedência

A única interseção material entre famílias ocorre de 18/10/2021 a 31/12/2024.
Ela é intencional e tem desempate jurídico:

1. testa-se primeiro o art. 4º da ECE 146/2021;
2. se todos os requisitos e critérios anteriores foram cumpridos no prazo,
   aplica-se a unidade preservada do Bloco B;
3. somente quando essa preservação não incide aplica-se a unidade permanente do
   Bloco C.

Não há opção livre entre regimes. Direitos formados até 31/12/2024 continuam
assegurados a qualquer tempo; depois dessa data não nasce novo enquadramento no
art. 4º.

# Combinações juridicamente impossíveis

Dentro de cada regime, as seguintes combinações são excluídas pela própria
norma:

- causa qualificada com ramo proporcional;
- causa comum com ramo sem proporcionalização;
- paridade na regra geral da EC 41;
- ausência de paridade no art. 6º-A;
- ausência de paridade na coorte da LCE 1.100 com ingresso até 31/12/2003; e
- paridade na coorte da LCE 1.100 com ingresso a partir de 01/01/2004.

A combinação média proporcional com paridade **não** é impossível: ela existe no
Bloco C para causa comum e ingresso até 31/12/2003, porque o art. 26 disciplina o
cálculo inicial e o art. 27, I, disciplina separadamente o reajuste.
