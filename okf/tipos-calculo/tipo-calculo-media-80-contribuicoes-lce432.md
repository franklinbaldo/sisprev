...
origem_legada:
  ...
  fidelidade: parcial
  justificativa: >-
    O rótulo não registra a seleção das 80% maiores bases contributivas desde
...
O caput do art. 45, na redação da LCE 672/2012, determina a média aritmética
simples das maiores remunerações contributivas correspondentes a 80% do período
desde julho de 1994 ou desde o início da contribuição, se posterior.

O § 10 limita o resultado à remuneração do cargo efetivo. O limitador é a
primeira e única operação da forma.
...
Saída: `provento_inicial`, média já submetida ao teto do § 10.
