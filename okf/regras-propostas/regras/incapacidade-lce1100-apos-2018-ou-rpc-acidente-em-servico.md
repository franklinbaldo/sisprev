---
type: RegraProposta
id: incapacidade-lce1100-apos-2018-ou-rpc-acidente-em-servico
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de acidente em serviço ou de hipótese legalmente
      equiparada, com nexo reconhecido, e não de evento excluído pelo art. 30, § 12, da
      LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A prova médica e administrativa demonstra incapacidade para as atribuições do
        cargo, impossibilidade de readaptação e nexo com acidente em serviço ou hipótese
        equiparada dos §§ 6º e 7º, afastado o dolo ou a culpa exclusiva da vítima de que
        trata o § 12?
      responsavel: perícia médica oficial indicada pelo IPERON e instrução previdenciária
      momento: instrução e seleção da regra
      meio_de_prova: >-
        laudo da perícia médica oficial, comunicação e apuração do acidente, prontuários
        e assentamentos funcionais
      evidencia_exigida: >-
        incapacidade para as atribuições do cargo e impossibilidade de readaptação
        comprovadas; ato ou conjunto probatório que reconheça o nexo com o serviço, por
        acidente direto ou hipótese equiparada; e afastamento da exclusão do § 12
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-caput/original.md
    papel: >-
      excetua o acidente em serviço da proporcionalização
  - ref: /dispositivos/lce-1100-2021/art-30-par-5/original.md
    papel: >-
      define acidente em serviço
  - ref: /dispositivos/lce-1100-2021/art-30-par-6/original.md
    papel: >-
      equipara a acidente em serviço as hipóteses que relaciona
  - ref: /dispositivos/lce-1100-2021/art-30-par-7/original.md
    papel: >-
      considera em exercício o servidor em descanso ou satisfação de necessidades
      fisiológicas durante o período de trabalho
  - ref: /dispositivos/lce-1100-2021/art-30-par-12/original.md
    papel: >-
      exclui da caracterização a lesão decorrente de dolo ou culpa exclusiva da vítima
...
projecao:
  nome: >-
    Incapacidade · acidente em serviço · ingresso após 05/11/2018 ou aderiu ao RPC ·
  ...
  fundamentacao_integral: >-
    ...
    nem de ser readaptado. Ficou demonstrado que a incapacidade decorreu de acidente em
    serviço — o ocorrido em exercício e relacionado, direta ou indiretamente, com as
    atribuições do cargo — ou de hipótese a ele legalmente equiparada, e que o nexo foi
    reconhecido a partir da comunicação e da apuração do acidente, dos prontuários e dos
    assentamentos funcionais. Ficou demonstrado, ainda, que o evento não decorreu de
    dolo ou culpa exclusiva da vítima, hipótese que a lei exclui da caracterização de
    acidente em serviço. Ficou demonstrado, por fim, que o interessado está sujeito ao
    regime de previdência complementar — seja porque o ingresso no serviço público em
    cargo efetivo se deu a partir de 6 de novembro de 2018, data da implementação do
    regime de previdência complementar estadual, seja porque fez a opção prévia e
    expressa de que trata o § 16 do art. 40 da Constituição Federal, ainda que tenha
    ingressado antes daquela data — e que os requisitos foram implementados a partir de
    ...
    de acidente em serviço — de modo que o reconhecimento do nexo decide o ramo do
    cálculo. O § 5º define acidente em serviço; o § 6º equipara a ele o acidente que,
    sem ser causa única, contribuiu decisivamente para a perda da capacidade, o sofrido
    no local e no horário do trabalho nas situações que enumera, a doença proveniente de
    contaminação acidental no exercício do cargo e o acidente sofrido fora do local e do
    horário de serviço nas hipóteses das suas alíneas; o § 7º considera em exercício o
    servidor em períodos de descanso ou de satisfação de necessidades fisiológicas
    durante o período de trabalho; e o § 12 afasta a caracterização quando a lesão
    decorre de dolo ou culpa exclusiva da vítima. O § 13 do art. 30 remete o cálculo das
    causas qualificadas ao art. 24. O art. 24 disciplina a média das maiores
    remunerações contributivas, e o seu § 10 impede que o provento exceda a remuneração
    do cargo efetivo. A esta hipótese acrescem os §§ 11 e 12 do mesmo artigo: o § 11
    sujeita ao limite máximo estabelecido para os benefícios do Regime Geral de
    Previdência Social o segurado sujeito ao regime de previdência complementar, nos
    termos dos §§ 14 a 16 do art. 40 da Constituição Federal; e o § 12 aplica esse mesmo
    limite a quem ingressou no serviço público a partir da implementação do regime de
    previdência complementar estadual, ocorrida em 6 de novembro de 2018. As duas vias
    levam ao mesmo resultado, e é por isso que a hipótese é uma só. O art. 27, inciso
    II, sujeita esta coorte ao reajustamento nos termos estabelecidos para o Regime
    Geral de Previdência Social, sem paridade.
...
proveniencia:
  fontes_consultadas:
    ...
    - /dispositivos/lce-1100-2021/art-30-par-6/original.md
    - /dispositivos/lce-1100-2021/art-30-par-7/original.md
    - /dispositivos/lce-1100-2021/art-30-par-12/original.md
  ...
  notas: >-
    ...
    acidente em serviço na família «ingresso após 05/11/2018 ou aderiu ao RPC». A
...
permanente decorrente de acidente em serviço, atestada por perícia médica oficial
...
Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R13`, `C1-R15`, `C1-R20`, `C1-R21`, `C1-R21a`, `C1-R21b`, `C1-R30`, `C1-R31`, `C1-R33`, `C1-R34`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R52`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74` da
