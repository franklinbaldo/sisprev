...
ressalva_homologacao: >-
  A homologação deve confirmar a projeção `Valor Efetivo` e o fluxo de reconhecimento do acidente em serviço; a fonte estadual da base permanece pendência jurídica.
origens_legacy:
  - regra-0001
  - regra-0002
predicados:
