...
- predicado: a incapacidade permanente decorre de moléstia profissional, com nexo ocupacional reconhecido
  protocolo_verificacao:
    pergunta: A prova médica e ocupacional demonstra incapacidade permanente e nexo entre a moléstia e o trabalho?
    responsavel: junta médica oficial e instrução previdenciária do IPERON
    meio_de_prova: laudo médico oficial, histórico ocupacional, prontuários, laudo ambiental e assentamentos funcionais
    momento: instrução e seleção da regra
    evidencia_exigida: conclusão médica de incapacidade permanente e prova suficiente do nexo ocupacional
...
proveniencia:
  ...
  notas: A legislação estadual é apurada na versão vigente na data do direito; mudança apenas de fonte não cria outra regra. Origem material: substituição.
decisoes:
- data: 2026-08-01
  quem: franklinbaldo
...
Hipótese de invalidez sob CF/88 original por moléstia profissional. A seleção exige prova positiva do nexo ocupacional.
