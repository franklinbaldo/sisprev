---
type: RegraProposta
id: incapacidade-lce1100-2004-ate-2018-sem-rpc-acidente-em-servico
ciclo: ciclo-01
schema_version: 1
...
projecao:
  nome: >-
    Incapacidade · acidente em serviço · ingresso de 2004 até 05/11/2018 e não aderiu ao
    RPC · integralidade da média contributiva
  ...
  fundamentacao_integral: >-
    ...
    acidente em serviço. Ficou demonstrado, por fim, que o ingresso no serviço público
    em cargo efetivo se deu depois de 31 de dezembro de 2003 e até 5 de novembro de
    2018, que o interessado não fez a opção pelo regime de previdência complementar de
    que trata o § 16 do art. 40 da Constituição Federal, e que os requisitos foram
    ...
    remunerações contributivas e, no próprio caput, alcança quem ingressou após 31 de
    dezembro de 2003 e não fez a opção do § 16 do art. 40 da Constituição Federal — que
    é a hipótese desta regra. O § 10 do art. 24 impede que o provento exceda a
    ...
    os proventos correspondem à média aritmética simples das maiores remunerações
    utilizadas como base para as contribuições, correspondentes a 80% de todo o período
    contributivo desde a competência de julho de 1994 ou desde a do início da
    contribuição, se posterior, atualizadas mês a mês na forma do art. 24, § 7º,
    observado o limite do art. 24, § 10, que impede o provento de exceder a remuneração
    do cargo efetivo em que se deu a aposentadoria. Não há redução proporcional ao tempo
    de contribuição. Após a concessão, os proventos não se reajustam por paridade: o
...
proveniencia:
  ...
  notas: >-
    ...
    acidente em serviço na família «ingresso de 2004 até 05/11/2018 e não aderiu ao
    RPC». A fórmula está decomposta em `tipo-calculo-media-80-contribuicoes-lce1100`.
...
readaptação. O cálculo é integralidade da média contributiva.

# Requisitos da matriz do Ciclo 1

Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R12`, `C1-R13`, `C1-R20`, `C1-R21`, `C1-R21a`, `C1-R21b`, `C1-R30`, `C1-R31`, `C1-R33`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R52`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74` da
