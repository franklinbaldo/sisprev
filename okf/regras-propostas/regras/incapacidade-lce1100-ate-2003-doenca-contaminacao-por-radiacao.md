---
type: RegraProposta
id: incapacidade-lce1100-ate-2003-doenca-contaminacao-por-radiacao
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de contaminação por radiação, moléstia relacionada
      no art. 30, § 8º, inciso XIII da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A perícia oficial confirma contaminação por radiação como causa da incapacidade
      ...
      meio_de_prova: >-
        ...
        complementar
      evidencia_exigida: >-
        diagnóstico de contaminação por radiação confirmado, incapacidade permanente
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-par-8-inc-xiii/original.md
    papel: >-
      nomeia contaminação por radiação entre as doenças graves, contagiosas ou incuráveis
...
projecao:
  nome: >-
    Incapacidade permanente · LCE 1.100 · ingresso até 2003 · contaminação por radiação
    · remuneração do cargo · integral · paridade S
  ...
  fundamentacao_integral: >-
    ...
    permanente para o trabalho, decorrente de contaminação por radiação, cujo
    ...
    por radiação, e é por essa via — e não por avaliação de gravidade caso a caso — que
...
proveniencia:
  ...
  notas: >-
    ...
    exclusivamente contaminação por radiação, pelo art. 30, § 8º, inciso XIII. Origem
...
contaminação por radiação após a filiação ao RPPS de Rondônia. Aplica-se a totalidade da remuneração do cargo efetivo (art. 25), sem proporcionalização
