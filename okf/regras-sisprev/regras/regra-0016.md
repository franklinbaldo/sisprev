...
id: regra-0016
row_index: 16
nome: Pensão por Morte (LC 1.100/2021) - SEXO=MASCULINO
...
# Pensão por Morte (LC 1.100/2021) - SEXO=MASCULINO
...
- Parâmetro cadastral `sexo: 'MASCULINO'` (predicado cadastral do sistema; a vinculação desta chave ao sexo do beneficiário vs. instituidor constitui hipótese a confirmar).
...
- Validação documental da relação de dependência previdenciária e averiguação dos requisitos de enquadramento do requerente.
