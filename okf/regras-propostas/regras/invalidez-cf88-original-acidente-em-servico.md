...
ressalva_homologacao: >-
  A homologação deve confirmar a projeção `Valor Efetivo` e o fluxo de
...
proveniencia:
  ...
  notas: >-
    ...
    interpretação sistemática dos arts. 94 e 154, § 2º. A mudança de diploma,
    sem alteração material do efeito integral, não cria outra regra. Origem
...
decisoes:
  ...
  - data: 2026-08-08
    ...
    o_que: >-
      ...
      auditoria sem converter as ressalvas operacionais em bloqueio jurídico.
confianca: media
---
