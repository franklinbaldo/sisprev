---
type: RegraProposta
id: incapacidade-lce1100-ate-2003-sem-rpc-acidente-em-servico
ciclo: ciclo-01
schema_version: 1
...
projecao:
  nome: >-
    Incapacidade · acidente em serviço · ingresso até 2003 e não aderiu ao RPC ·
    remuneração do cargo · integral · com paridade
  ...
  fundamentacao_integral: >-
    ...
    em cargo efetivo se deu até 31 de dezembro de 2003, que o interessado não fez a
    opção pelo regime de previdência complementar de que trata o § 16 do art. 40 da
    Constituição Federal, e que os requisitos foram implementados a partir de 18 de
    outubro de 2021.
    ...
    causas qualificadas ao art. 24. Para quem ingressou no serviço público em cargo
    efetivo até 31 de dezembro de 2003 e não fez a opção do § 16 do art. 40 da
    Constituição Federal, é o art. 25 que disciplina a base de cálculo — a totalidade da
    remuneração do cargo efetivo —, e o art. 27, inciso I, que assegura a paridade, cujo
    conteúdo está no art. 7º da Emenda Constitucional nº 41/2003.


    Para os servidores que ingressaram no serviço público até 31 de dezembro de 2003 e
    não fizeram a opção pelo regime de previdência complementar, os proventos
    correspondem à totalidade da remuneração do cargo efetivo, nos termos do art. 25 da
    LCE nº 1.100/2021, sem redução proporcional ao tempo de contribuição, com paridade
    na forma do art. 27, I. Após a concessão, os proventos são reajustados na mesma
...
proveniencia:
  ...
  notas: >-
    ...
    acidente em serviço na família «ingresso até 2003 e não aderiu ao RPC». A fórmula
    está decomposta em `tipo-calculo-totalidade-remuneracao-cargo-efetivo-lce1100`.
...
readaptação. O cálculo é remuneração do cargo · integral · com paridade.

# Requisitos da matriz do Ciclo 1

Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R11`, `C1-R13`, `C1-R20`, `C1-R21`, `C1-R21a`, `C1-R21b`, `C1-R30`, `C1-R31`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R51`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74` da
