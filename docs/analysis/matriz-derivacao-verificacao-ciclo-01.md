...
| Surdez permanente (magistério) | XVI    | art-30-par-8-inc-xvi  | `incapacidade-lce1100-ate-2003-doenca-surdez-permanente-magisterio`  | `incapacidade-lce1100-apos-2003-doenca-surdez-permanente-magisterio`  | R20,R23,R23a,R23b,R24 + comuns                                                   | deployable / deployable | coberto (C1-R24 encerrado em 2026-08-05)               |
| Anomalia da fala (magistério)  | XVI    | art-30-par-8-inc-xvi  | `incapacidade-lce1100-ate-2003-doenca-anomalia-da-fala-magisterio`   | `incapacidade-lce1100-apos-2003-doenca-anomalia-da-fala-magisterio`   | R20,R23,R23a,R23b,R24 + comuns                                                   | deployable / deployable | coberto (C1-R24 encerrado em 2026-08-05)               |
| Causa comum                    | —      | art. 30, caput e § 14 | `incapacidade-lce1100-ate-2003-causa-comum`                          | `incapacidade-lce1100-apos-2003-causa-comum`                          | R20,R25,R30,**R32**,R42 + comuns                                                 | deployable / deployable | **derivação concluída; implantação pendente (C1-R32)** |
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------- | ---------- |
| Confirmação de que `Proporcionalidade Dias` identifica esta fórmula no Sisprev sem ambiguidade com outras fórmulas de causa comum que compartilham o rótulo | dependência de implantação (não bloqueia `deployable`; bloqueia troca da fonte operacional do grupo) | C1-R32 (2 regras)                     | #122, #124 |
...
impede é especificamente a troca da fonte operacional de exportação do
grupo a que pertencem (`okf/spec/conjunto.md`) — os dois grupos do Bloco C
permanecem `estado_grupo: inativo` até a confirmação, sem que isso impeça o
fechamento do ciclo quanto a essa derivação (`okf/spec/ciclo.md`, emenda do
round 9 da RFC 0004).
