---
type: RegraProposta
id: incapacidade-lce1100-ate-2003-sem-rpc-molestia-profissional
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de moléstia reconhecida como profissional no
      processo concessório
    protocolo_verificacao:
      pergunta: >-
        O laudo médico, o histórico ocupacional e a decisão administrativa fundamentada
        reconhecem a moléstia como profissional, com incapacidade para as atribuições do
        cargo e impossibilidade de readaptação?
      responsavel: perícia médica oficial indicada pelo IPERON e instrução previdenciária
      momento: instrução e seleção da regra
      meio_de_prova: >-
        laudo da perícia médica oficial, histórico ocupacional, prontuários e decisão
        administrativa fundamentada
      evidencia_exigida: >-
        incapacidade para as atribuições do cargo e impossibilidade de readaptação
        comprovadas, e reconhecimento da moléstia como profissional no processo
        concessório
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-caput/original.md
    papel: >-
      excetua a moléstia profissional da proporcionalização, sem defini-la
...
projecao:
  nome: >-
    Incapacidade · moléstia profissional · ingresso até 2003 e não aderiu ao RPC ·
  ...
  fundamentacao_integral: >-
    ...
    nem de ser readaptado. Ficou demonstrado, mediante laudo médico, histórico
    ocupacional e decisão administrativa fundamentada, que a incapacidade decorreu de
    moléstia reconhecida como profissional no processo concessório. Ficou demonstrado,
    por fim, que o ingresso no serviço público em cargo efetivo se deu até 31 de
    dezembro de 2003, que o interessado não fez a opção pelo regime de previdência
    ...
    de moléstia profissional. A Lei Complementar não define moléstia profissional nem
    remete a rol, de modo que o reconhecimento se faz no processo concessório, por
    decisão administrativa fundamentada apoiada em laudo médico e em histórico
    ocupacional. O § 13 do art. 30 remete o cálculo das causas qualificadas ao art. 24.
    Para quem ingressou no serviço público em cargo efetivo até 31 de dezembro de 2003 e
    não fez a opção do § 16 do art. 40 da Constituição Federal, é o art. 25 que
    disciplina a base de cálculo — a totalidade da remuneração do cargo efetivo —, e o
    art. 27, inciso I, que assegura a paridade, cujo conteúdo está no art. 7º da Emenda
...
proveniencia:
  ...
  notas: >-
    ...
    moléstia profissional na família «ingresso até 2003 e não aderiu ao RPC». A fórmula
...
decisoes:
  ...
  - data: 2026-08-04
    ...
    o_que: >-
      ...
      contra a causa qualificada da coorte até 2003. Evidência em
  ...
  - data: 2026-08-05
    ...
    o_que: >-
      ...
      distinção de 2026-08-01 que separava esta regra do "regime geral do
      art. 25". A leitura anterior — média do art. 24 combinada com
      paridade, via art. 30, § 13 — é juridicamente construível a partir
      da remissão daquele parágrafo, mas conflita com o art. 25, que rege
      expressamente, com a mesma grafia do art. 27, I, a coorte "que tenha
      ingressado no serviço público em cargo efetivo até 31 de dezembro de
      2003"; altera a fórmula que `regra-0019` já grava em produção para
      esta mesma hipótese (`tipo_calculo: Valor Efetivo`, citando o próprio
      art. 25 em `dispositivos:`); e carece de jurisprudência específica ou
      precedente administrativo interno inequívoco que sustente a
      combinação média + paridade. A orientação conservadora adotada
      preserva a coerência de regime pela coorte: quem ingressou até 2003
      calcula sobre a remuneração do cargo (art. 25) com paridade (art. 27,
      I); quem ingressou depois calcula pela média (art. 24) sem paridade.
      A tensão entre os arts. 25 e 30, § 13 permanece questão
      interpretativa, não resolvida por esta decisão, e pode ser revista
...
permanente decorrente de moléstia profissional, atestada por perícia médica oficial
...
Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R11`, `C1-R13`, `C1-R20`, `C1-R22`, `C1-R30`, `C1-R31`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R51`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74`, `C1-R75` da
