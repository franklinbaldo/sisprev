---
type: RegraProposta
id: incapacidade-lce1100-ate-2003-doenca-doenca-de-paget
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
    ...
    protocolo_verificacao:
      pergunta: >-
        A perícia oficial confirma estado avançado da doença de Paget (osteíte deformante)
        como causa da incapacidade permanente, e o acometimento é posterior à filiação ao
        RPPS de Rondônia?
      ...
      evidencia_exigida: >-
        ...
        confirmado, incapacidade permanente para o trabalho e acometimento posterior à
        filiação; e ausência de opção pelo regime de previdência complementar de que
        trata o § 16 do art. 40 da Constituição Federal, de que a paridade depende
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-caput/original.md
    papel: excetua a doença grave da proporcionalização
  - ref: /dispositivos/lce-1100-2021/art-30-par-8/original.md
    papel: exige o acometimento posterior à filiação e abre o rol
...
projecao:
  nome: >-
    Incapacidade permanente · LCE 1.100 · ingresso até 2003 · estado avançado da doença
    de Paget (osteíte deformante) · remuneração do cargo · integral · paridade S
  ...
  fundamentacao_integral: >-
    ...
    permanente para o trabalho, decorrente de estado avançado da doença de Paget
    (osteíte deformante), cujo diagnóstico foi confirmado por junta médica oficial
    mediante laudo, exames e prontuários, e cotejado com o rol legal em vigor. Ficou
    demonstrado que o interessado foi acometido da doença depois de sua filiação ao
    regime próprio de previdência de Rondônia, requisito que o próprio parágrafo impõe a
    todas as moléstias que relaciona. Ficou demonstrado, por fim, que o ingresso no
    serviço público em cargo efetivo se deu até 31 de dezembro de 2003 e que os
    requisitos foram implementados a partir de 18 de outubro de 2021. Ficou demonstrado,
    também, que o interessado não fez a opção pelo regime de previdência complementar de
    que trata o § 16 do art. 40 da Constituição Federal, condição a que a lei subordina
    o reajustamento com paridade.
    ...
    excetua da proporcionalização a incapacidade decorrente de doença grave, contagiosa
    ou incurável — de modo que o enquadramento da moléstia não é detalhe
    classificatório: dele depende haver ou não redução no provento. Qual seja essa
    doença o caput não diz, e é o § 8º do mesmo artigo que fecha a hipótese,
    ...
    gravidade caso a caso — que a moléstia produz o resultado sem proporcionalização. O § 13 do art. 30 remete as causas qualificadas ao art. 24; por leitura conservadora da
...
proveniencia:
  ...
  notas: >-
    ...
    exclusivamente estado avançado da doença de Paget (osteíte deformante), pelo art.
    30, § 8º, inciso XI. Origem material: substituição.
decisoes:
  - data: 2026-08-03
    quem: franklinbaldo
    o_que: >-
...
de Rondônia. Aplica-se a totalidade da remuneração do cargo efetivo (art. 25), sem proporcionalização
...
Esta regra materializa os requisitos `C1-R00`, `C1-R10`, `C1-R11`, `C1-R13`, `C1-R20`, `C1-R23`, `C1-R23a`, `C1-R23b`, `C1-R30`, `C1-R31`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R51`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74` da
