---
type: RegraProposta
id: incapacidade-lce1100-apos-2018-ou-rpc-doenca-espondiloartrose-anquilosante
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de espondiloartrose anquilosante, moléstia
      relacionada no art. 30, § 8º, inciso IX, da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A perícia médica oficial confirma espondiloartrose anquilosante como causa da
        incapacidade, com impossibilidade de readaptação, e o acometimento é posterior à
        filiação ao RPPS de Rondônia?
      ...
      evidencia_exigida: >-
        diagnóstico de espondiloartrose anquilosante confirmado, incapacidade para as
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-par-8-inc-ix/original.md
    papel: >-
      nomeia espondiloartrose anquilosante entre as doenças graves, contagiosas ou
      incuráveis
...
projecao:
  nome: >-
    Incapacidade · espondiloartrose anquilosante · ingresso após 05/11/2018 ou aderiu ao
  ...
  fundamentacao_integral: >-
    ...
    nem de ser readaptado. Ficou demonstrado que a incapacidade decorreu de
    espondiloartrose anquilosante, cujo diagnóstico foi confirmado por perícia médica
    ...
    de previdência de Rondônia. Ficou demonstrado, por fim, que o interessado está
    sujeito ao regime de previdência complementar — seja porque o ingresso no serviço
    público em cargo efetivo se deu a partir de 6 de novembro de 2018, data da
    ...
    acometido após a filiação. É o art. 30, § 8º, inciso IX que nomeia espondiloartrose
    anquilosante, e é por essa via — e não por avaliação de gravidade caso a caso — que
    a moléstia produz o resultado sem proporcionalização. O § 13 do art. 30 remete o
...
proveniencia:
  fontes_consultadas:
    ...
    - /dispositivos/lce-1100-2021/art-30-par-8-inc-ix/original.md
  ...
  notas: >-
    ...
    espondiloartrose anquilosante na família «ingresso após 05/11/2018 ou aderiu ao
    RPC». A fórmula está decomposta em `tipo-calculo-media-80-contribuicoes-teto-rgps-
    lce1100`. Origem material: substituição.
decisoes:
  - data: 2026-08-05
    quem: franklinbaldo
    o_que: >-
...
permanente decorrente de espondiloartrose anquilosante, atestada por perícia médica oficial
...
Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R13`, `C1-R15`, `C1-R20`, `C1-R23`, `C1-R23a`, `C1-R23b`, `C1-R30`, `C1-R31`, `C1-R33`, `C1-R34`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R52`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74` da
