---
type: RegraProposta
id: incapacidade-lce1100-ate-2003-sem-rpc-doenca-paralisia-irreversivel
ciclo: ciclo-01
schema_version: 1
...
projecao:
  nome: >-
    Incapacidade · paralisia irreversível e incapacitante · ingresso até 2003 e não
    aderiu ao RPC · remuneração do cargo · integral · com paridade
  ...
  fundamentacao_integral: >-
    ...
    público em cargo efetivo se deu até 31 de dezembro de 2003, que o interessado não
    fez a opção pelo regime de previdência complementar de que trata o § 16 do art. 40
    da Constituição Federal, e que os requisitos foram implementados a partir de 18 de
    outubro de 2021.
    ...
    art. 30 remete o cálculo das causas qualificadas ao art. 24. Para quem ingressou no
    serviço público em cargo efetivo até 31 de dezembro de 2003 e não fez a opção do §
    16 do art. 40 da Constituição Federal, é o art. 25 que disciplina a base de cálculo
    — a totalidade da remuneração do cargo efetivo —, e o art. 27, inciso I, que
    assegura a paridade, cujo conteúdo está no art. 7º da Emenda Constitucional nº
    41/2003.
...
proveniencia:
  ...
  notas: >-
    ...
    paralisia irreversível e incapacitante na família «ingresso até 2003 e não aderiu ao
    RPC». A fórmula está decomposta em `tipo-calculo-totalidade-remuneracao-cargo-
    efetivo-lce1100`. Origem material: substituição.
decisoes:
  - data: 2026-08-03
    quem: franklinbaldo
    o_que: >-
