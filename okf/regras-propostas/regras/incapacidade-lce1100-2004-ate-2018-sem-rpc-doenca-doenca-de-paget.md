---
type: RegraProposta
id: incapacidade-lce1100-2004-ate-2018-sem-rpc-doenca-doenca-de-paget
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de estado avançado da doença de Paget (osteíte
      deformante), moléstia relacionada no art. 30, § 8º, inciso XI, da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A perícia médica oficial confirma estado avançado da doença de Paget (osteíte
        deformante) como causa da incapacidade, com impossibilidade de readaptação, e o
        acometimento é posterior à filiação ao RPPS de Rondônia?
      ...
      evidencia_exigida: >-
        diagnóstico de estado avançado da doença de Paget (osteíte deformante)
        confirmado, incapacidade para as atribuições do cargo, impossibilidade de
        readaptação e acometimento posterior à filiação
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-par-8-inc-xi/original.md
    papel: >-
      nomeia estado avançado da doença de Paget (osteíte deformante) entre as doenças
...
projecao:
  nome: >-
    Incapacidade · estado avançado da doença de Paget (osteíte deformante) · ingresso de
    2004 até 05/11/2018 e não aderiu ao RPC · integralidade da média contributiva
  ...
  fundamentacao_integral: >-
    ...
    nem de ser readaptado. Ficou demonstrado que a incapacidade decorreu de estado
    avançado da doença de Paget (osteíte deformante), cujo diagnóstico foi confirmado
    por perícia médica oficial mediante laudo, exames e prontuários, e cotejado com o
    rol legal em vigor, e que o interessado foi acometido da doença depois de sua
    filiação ao regime próprio de previdência de Rondônia. Ficou demonstrado, por fim,
    que o ingresso no serviço público em cargo efetivo se deu depois de 31 de dezembro
    de 2003 e até 5 de novembro de 2018, que o interessado não fez a opção pelo regime
    de previdência complementar de que trata o § 16 do art. 40 da Constituição Federal,
    e que os requisitos foram implementados a partir de 18 de outubro de 2021.
    ...
    acometido após a filiação. É o art. 30, § 8º, inciso XI que nomeia estado avançado
    da doença de Paget (osteíte deformante), e é por essa via — e não por avaliação de
    gravidade caso a caso — que a moléstia produz o resultado sem proporcionalização. O
    § 13 do art. 30 remete o cálculo das causas qualificadas ao art. 24. O art. 24
    disciplina a média das maiores remunerações contributivas e, no próprio caput,
    alcança quem ingressou após 31 de dezembro de 2003 e não fez a opção do § 16 do art.
    40 da Constituição Federal — que é a hipótese desta regra. O § 10 do art. 24 impede
    que o provento exceda a remuneração do cargo efetivo. O limite máximo dos benefícios
    do Regime Geral, dos §§ 11 e 12 do art. 24, não incide aqui: o § 11 alcança o
    segurado sujeito ao regime de previdência complementar, e o § 12, quem ingressou a
    partir de 6 de novembro de 2018 — duas condições que esta regra exclui. O art. 27,
    inciso II, sujeita esta coorte ao reajustamento nos termos estabelecidos para o
    Regime Geral de Previdência Social, sem paridade.
...
proveniencia:
  fontes_consultadas:
    ...
    - /dispositivos/lce-1100-2021/art-30-par-8-inc-xi/original.md
  ...
  notas: >-
    ...
    estado avançado da doença de Paget (osteíte deformante) na família «ingresso de 2004
    até 05/11/2018 e não aderiu ao RPC». A fórmula está decomposta em `tipo-calculo-
    media-80-contribuicoes-lce1100`. Origem material: substituição.
decisoes:
  - data: 2026-08-03
    quem: franklinbaldo
    o_que: >-
...
permanente decorrente de estado avançado da doença de Paget (osteíte deformante), atestada por perícia médica oficial
...
Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R12`, `C1-R13`, `C1-R20`, `C1-R23`, `C1-R23a`, `C1-R23b`, `C1-R30`, `C1-R31`, `C1-R33`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R52`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R73`, `C1-R74` da
