...
- **P9_INTEGRAL_SEM_FUNDAMENTACAO**: 15 regras declaram explicitamente `integral: N`, porém deixam a seção `# Fundamentação Proporcional` vazia. (Novo `achado-0009` criado).
...
- **P9_* (31 ocorrências)**: Relacionados a campos e preenchimento (descritos no item 2). Novos achados gerados para cobertura.
