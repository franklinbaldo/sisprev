...
pela fração do art. 26 (`forma-calculo-media-proporcional-dias-lce1100.md`).
...
também é gravado no catálogo legado por outras fórmulas de causa comum (LCE
432/2008; art. 6º-A/EC 70/2012), o que é fato observável no catálogo, não
suposição. Falta confirmação de que o rótulo — ou outro campo do schema
...
**O Ciclo 1 não está encerrado.** Um requisito específico permanece
pendente de decisão da coordenação antes que a condição 9 de
`okf/spec/ciclo.md` se demonstre para o Bloco C inteiro:
...
**C1-R32 não é mais pendência de auditoria.** A fórmula da causa comum sob
...
cada uma está definido, com responsável e evidência — o que resta, fora de
C1-R24, é a constatação no caso concreto (trabalho do processo
administrativo) e a confirmação de implantação de C1-R32 (trabalho do
IPERON/fornecedor), nenhuma das duas defeito de derivação.
...
| mapeamento pendente de `tipo_calculo` (C1-R32) | `okf/formas-calculo/forma-calculo-media-proporcional-dias-lce1100.md`, [issue #122](https://github.com/franklinbaldo/sisprev/issues/122) |
