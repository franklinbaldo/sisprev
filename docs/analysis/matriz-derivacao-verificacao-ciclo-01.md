...
1.100/2021 está integralmente derivada: média do art. 24, proporcionalizada
pela fração do art. 26 (`tipo-calculo-media-proporcional-dias-lce1100.md`).
...
"Atomicidade é derivada, não declarada") — as quatro regras legadas do
Bloco C permanecem a fonte operacional de exportação até a confirmação,
sem que isso impeça o fechamento do ciclo quanto a essa derivação
(`okf/spec/ciclo.md`, emenda do round 9 da RFC 0004).
...
implantação do Bloco C em `data/regras-propostas.csv`: a decisão jurídica
de que os vinte destinos de cada componente cobrem exaustivamente as
causas do art. 30 está registrada e não foi revista desde 03/08/2026
(`okf/regras-sisprev/ciclos/ciclo-01.md`, T7), e a entrada na carga de
implantação depende dela mais o estado de implantação dos destinos
(RFC 0004, round 11; `okf/spec/regraproposta.md`), permanecendo fora da
carga até a confirmação de C1-R32.
