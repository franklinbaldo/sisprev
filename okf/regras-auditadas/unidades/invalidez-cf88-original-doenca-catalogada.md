...
proveniencia:
  ...
  notas: O rol é taxonomia versionada pela data do direito, não uma série de regras por doença ou por diploma. Origem material: substituição.
decisoes:
- data: 2026-08-01
  quem: franklinbaldo
  o_que: Decompor o Bloco A por regime constitucional e classe de causa, mantendo o rol como taxonomia temporal.
confianca: media
---

# Síntese

Hipótese de invalidez sob CF/88 original por doença grave catalogada. A correspondência ao rol deve ser verificada na versão vigente quando o direito foi implementado.
