...
id: regra-0016
row_index: 16
nome: Pensão por Morte (LC 1.100/2021) - Beneficiário Masculino
...
# Pensão por Morte (LC 1.100/2021) - Beneficiário Masculino

# Critérios avaliados pelo Sisprev

- Parâmetro cadastral `status_operacional: 'TRUE'`.
- Parâmetro cadastral `sexo: 'MASCULINO'` (predicado de seleção para dependentes do sexo masculino).
...
- Validação documental do sexo/gênero masculino do dependente e comprovação da relação de dependência.
...
- Documento de identidade civil (RG e CPF) do beneficiário masculino.
