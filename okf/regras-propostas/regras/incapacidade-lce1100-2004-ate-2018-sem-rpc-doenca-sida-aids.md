---
type: RegraProposta
id: incapacidade-lce1100-2004-ate-2018-sem-rpc-doenca-sida-aids
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de síndrome da imunodeficiência adquirida
      (SIDA/AIDS), moléstia relacionada no art. 30, § 8º, inciso XII, da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A perícia médica oficial confirma síndrome da imunodeficiência adquirida
        (SIDA/AIDS) como causa da incapacidade, com impossibilidade de readaptação, e o
      ...
      evidencia_exigida: >-
        diagnóstico de síndrome da imunodeficiência adquirida (SIDA/AIDS) confirmado,
        incapacidade para as atribuições do cargo, impossibilidade de readaptação e
        acometimento posterior à filiação
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-par-8-inc-xii/original.md
    papel: >-
      nomeia síndrome da imunodeficiência adquirida (SIDA/AIDS) entre as doenças graves,
...
projecao:
  nome: >-
    Incapacidade · síndrome da imunodeficiência adquirida (SIDA/AIDS) · ingresso de 2004
    até 05/11/2018 e não aderiu ao RPC · integralidade da média contributiva
  ...
  fundamentacao_integral: >-
    ...
    nem de ser readaptado. Ficou demonstrado que a incapacidade decorreu de síndrome da
    imunodeficiência adquirida (SIDA/AIDS), cujo diagnóstico foi confirmado por perícia
    médica oficial mediante laudo, exames e prontuários, e cotejado com o rol legal em
    vigor, e que o interessado foi acometido da doença depois de sua filiação ao regime
    próprio de previdência de Rondônia. Ficou demonstrado, por fim, que o ingresso no
    serviço público em cargo efetivo se deu depois de 31 de dezembro de 2003 e até 5 de
    novembro de 2018, que o interessado não fez a opção pelo regime de previdência
    complementar de que trata o § 16 do art. 40 da Constituição Federal, e que os
    ...
    acometido após a filiação. É o art. 30, § 8º, inciso XII que nomeia síndrome da
    imunodeficiência adquirida (SIDA/AIDS), e é por essa via — e não por avaliação de
...
proveniencia:
  fontes_consultadas:
    ...
    - /dispositivos/lce-1100-2021/art-30-par-8-inc-xii/original.md
  ...
  notas: >-
    ...
    síndrome da imunodeficiência adquirida (SIDA/AIDS) na família «ingresso de 2004 até
    05/11/2018 e não aderiu ao RPC». A fórmula está decomposta em `tipo-calculo-
...
permanente decorrente de síndrome da imunodeficiência adquirida (SIDA/AIDS), atestada por perícia médica oficial
