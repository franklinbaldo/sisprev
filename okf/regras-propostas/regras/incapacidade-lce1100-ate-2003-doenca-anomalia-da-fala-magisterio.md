---
type: RegraProposta
id: incapacidade-lce1100-ate-2003-doenca-anomalia-da-fala-magisterio
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de anomalia da fala, moléstia relacionada no art.
      30, § 8º, inciso XVI da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A perícia oficial confirma anomalia da fala como causa da incapacidade permanente, e
        o acometimento é posterior à filiação ao RPPS de Rondônia?
      ...
      meio_de_prova: >-
        ...
        complementar
      evidencia_exigida: >-
        diagnóstico de anomalia da fala confirmado, incapacidade permanente para o
...
projecao:
  nome: >-
    Incapacidade permanente · LCE 1.100 · ingresso até 2003 · anomalia da fala ·
    magistério · média integral · paridade S
  ...
  fundamentacao_integral: >-
    ...
    permanente para o trabalho, decorrente de anomalia da fala, cujo diagnóstico foi
    confirmado por junta médica oficial mediante laudo, exames e prontuários, e cotejado
    com o rol legal em vigor. Ficou demonstrado que o interessado foi acometido da
    doença depois de sua filiação ao regime próprio de previdência de Rondônia,
    requisito que o próprio parágrafo impõe a todas as moléstias que relaciona. Ficou
    demonstrado, também, que o interessado ocupava cargo de magistério, condição a que o
    inciso restringe esta moléstia. Ficou demonstrado, por fim, que o ingresso no
    ...
    fala, e é por essa via — e não por avaliação de gravidade caso a caso — que a
    moléstia produz o resultado sem proporcionalização. O § 13 do art. 30 remete as
    causas qualificadas à média do art. 24, que disciplina sobre que valor o cálculo
    incide.
...
proveniencia:
  ...
  notas: >-
    ...
    exclusivamente anomalia da fala, pelo art. 30, § 8º, inciso XVI. Origem material:
    substituição.
decisoes:
  - data: 2026-08-03
    quem: franklinbaldo
...
anomalia da fala após a filiação ao RPPS de Rondônia. Aplica-se a média do art.
24 sem proporcionalização.

# Requisitos da matriz do Ciclo 1

Esta regra materializa os requisitos `C1-R00`, `C1-R10`, `C1-R11`, `C1-R13`, `C1-R20`, `C1-R23`, `C1-R23a`, `C1-R23b`, `C1-R24`, `C1-R30`, `C1-R31`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R51`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R72`, `C1-R73`, `C1-R74` da
