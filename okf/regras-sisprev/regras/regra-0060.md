...
row_index: 60
id_sisprev: '110'
nome_original: Voluntária do Servidor Com Deficiência - Art. 35, inciso II da Lei Complementar 1.100/2021 (MODERADA)
nome: Voluntária · Deficiência moderada · pedido a partir de 18/10/2021 · Masculino · integral · média
...
disposicao_de_achados:
  ...
  - achado: /achados/achado-0004.md
    disposicao: corrigida
    justificativa: >-
      **Corrigida diferenciando a fundamentação, que é o campo que o detector
      lê.** O grupo existia porque `regra-0060` e `regra-0064` gravavam
