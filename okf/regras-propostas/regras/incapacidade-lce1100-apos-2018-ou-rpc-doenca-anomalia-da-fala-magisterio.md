---
type: RegraProposta
id: incapacidade-lce1100-apos-2018-ou-rpc-doenca-anomalia-da-fala-magisterio
ciclo: ciclo-01
schema_version: 1
...
requisitos_verificacao_humana:
  - predicado: >-
      a incapacidade permanente decorre de anomalia da fala, moléstia relacionada no
      art. 30, § 8º, inciso XVI, da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        A perícia médica oficial confirma anomalia da fala como causa da incapacidade,
        com impossibilidade de readaptação, e o acometimento é posterior à filiação ao
        RPPS de Rondônia?
      responsavel: perícia médica oficial indicada pelo IPERON
      momento: instrução e seleção da regra
      meio_de_prova: >-
        laudo da perícia médica oficial, exames e prontuários, mais os assentamentos
        funcionais que situam a filiação
      evidencia_exigida: >-
        diagnóstico de anomalia da fala confirmado, incapacidade para as atribuições do
        cargo, impossibilidade de readaptação e acometimento posterior à filiação
    portador_primario: fundamentacao_integral
  - predicado: >-
      o interessado se enquadra em caso de magistério para os fins do art. 30, § 8º,
      inciso XVI, da LCE 1.100/2021
    protocolo_verificacao:
      pergunta: >-
        As circunstâncias funcionais registradas nos assentamentos caracterizam caso de
        magistério para os fins do inciso XVI?
      responsavel: unidade de gestão de pessoas
      momento: instrução e seleção da regra
      meio_de_prova: >-
        assentamentos funcionais, atos de lotação e demais documentos da instrução
      evidencia_exigida: >-
        assentamento funcional que comprove o enquadramento como caso de magistério, sem
        exigência de marco temporal específico não previsto no dispositivo
    portador_primario: fundamentacao_integral
...
taxonomias:
  ...
  - ref: /dispositivos/lce-1100-2021/art-30-par-8-inc-xvi/original.md
    papel: >-
      nomeia anomalia da fala entre as doenças graves, contagiosas ou incuráveis,
      restrita ao caso de magistério
...
projecao:
  nome: >-
    Incapacidade · magistério · anomalia da fala · ingresso após 05/11/2018 ou aderiu ao
    RPC · média contributiva limitada ao teto do RGPS
  ...
  fundamentacao_integral: >-
    ...
    nem de ser readaptado. Ficou demonstrado que a incapacidade decorreu de anomalia da
    fala, cujo diagnóstico foi confirmado por perícia médica oficial mediante laudo,
    exames e prontuários, e cotejado com o rol legal em vigor, e que o interessado foi
    acometido da doença depois de sua filiação ao regime próprio de previdência de
    Rondônia. Ficou demonstrado, pelos assentamentos funcionais, que as circunstâncias
    funcionais relevantes ao benefício caracterizavam caso de magistério para os fins do
    art. 30, § 8º, XVI. Ficou demonstrado, por fim, que o interessado está sujeito ao
    ...
    acometido após a filiação. É o art. 30, § 8º, inciso XVI que nomeia anomalia da
    fala, restringindo a hipótese ao caso de magistério — condição funcional que o
    inciso exige e que, por isso, é aferida no caso concreto. O § 13 do art. 30 remete o
    cálculo das causas qualificadas ao art. 24. O art. 24 disciplina a média das maiores
...
proveniencia:
  fontes_consultadas:
    ...
    - /dispositivos/lce-1100-2021/art-30-par-8-inc-xvi/original.md
  ...
  notas: >-
    ...
    anomalia da fala na família «ingresso após 05/11/2018 ou aderiu ao RPC». A fórmula
    está decomposta em `tipo-calculo-media-80-contribuicoes-teto-rgps-lce1100`. Origem
...
Hipótese da LCE 1.100/2021 para ingresso após 05/11/2018 ou aderiu ao RPC · magistério, com incapacidade
permanente decorrente de anomalia da fala, atestada por perícia médica oficial
...
Esta regra materializa os requisitos `C1-R00`, `C1-R01`, `C1-R02`, `C1-R03`, `C1-R10`, `C1-R13`, `C1-R15`, `C1-R20`, `C1-R23`, `C1-R23a`, `C1-R23b`, `C1-R24`, `C1-R30`, `C1-R31`, `C1-R33`, `C1-R34`, `C1-R40`, `C1-R41`, `C1-R50`, `C1-R52`, `C1-R60`, `C1-R61`, `C1-R70`, `C1-R71`, `C1-R72`, `C1-R73`, `C1-R74` da
