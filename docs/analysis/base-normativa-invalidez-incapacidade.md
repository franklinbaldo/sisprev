...
- **`sapl.al.ro.leg.br`** (ALE-RO/SAPL, o sistema de apoio ao processo
  legislativo) segue **inacessível deste ambiente**: o endpoint ao vivo
  respondeu **HTTP 429 em todas as tentativas** (7 tentativas, em dois
  dias de trabalho distintos) — bloqueio do WAF ao IP do ambiente de
  execução, não uma falha pontual. Por isso a ECE 146/2021 **não** é mais
  sourced a partir desse domínio nesta versão.
- **`transparencia.al.ro.leg.br`** (Portal da Transparência da ALE-RO, um
  ...
  **Diário Oficial Eletrônico da Assembleia Legislativa de Rondônia**
  (DO-e-ALE/RO) — a publicação oficial em si, não uma norma compilada por
  terceiros. A **Edição nº 163, Extra, de 14/09/2021**
  ...
  escaneado; `Producer: Microsoft: Print To PDF`), fonte de maior
  confiabilidade que a cópia arquivada usada nas rodadas anteriores desta
  matriz. Substitui o `fonte:` de `ece-146-2021/art-4` e resolve, ao mesmo
  tempo, texto **e** data de publicação (§2).
...
| `ece-146-2021/art-4`         | ECE 146/2021, art. 4º (caput + § único)           | **2021-09-14** →¹           | DO-e-ALE/RO, Ed. 163 Extra (§1)  | **HIGH**¹ |
...
¹ **Sobre `ece-146-2021/art-4`**: tanto o **texto** quanto a **data de
vigência** são agora confirmados por fonte primária direta — a **Edição nº
163, Extra, do Diário Oficial Eletrônico da Assembleia Legislativa de
Rondônia (DO-e-ALE/RO)**, de **14/09/2021**, que publica o texto integral
da emenda (§1). Esse PDF tem texto extraível nativamente (não é uma
digitalização/OCR) e é, ele mesmo, o ato de publicação — não uma
compilação de terceiros. O `fonte:` do dispositivo foi trocado da cópia
arquivada (Wayback) da norma no SAPL para esse PDF do Diário Oficial. O
art. 13 da própria emenda diz que ela "entra em vigor **na data de sua
publicação**" — e essa data, **agora confirmada em fonte primária**, é
14/09/2021 (não 09/09/2021, que é a data de **promulgação**, lida no
rodapé do documento — "ASSEMBLEIA LEGISLATIVA, 9 de setembro de 2021" —
mas que o próprio art. 13 não elege como o marco de vigência). O
dispositivo passa a carregar `vigencia_inicio: 2021-09-14`; a pendência
P-EC146 das rodadas anteriores está **fechada**, tanto quanto ao texto
quanto à vigência (§6).
...
| P-EC146 | **Fechada nesta rodada.** `ece-146-2021/art-4`: texto e data de vigência confirmados por fonte primária direta — a Edição nº 163, Extra, do Diário Oficial Eletrônico da Assembleia Legislativa de Rondônia (DO-e-ALE/RO), 14/09/2021, publicando o texto integral da emenda (§1/§2). `vigencia_inicio` corrigido de 2021-09-09 (promulgação) para 2021-09-14 (publicação, o marco que o art. 13 da própria emenda exige); `fonte:` trocado da cópia arquivada do SAPL para o PDF do Diário Oficial. O endpoint ao vivo do SAPL (`sapl.al.ro.leg.br`) segue respondendo 429 neste ambiente, mas deixou de ser necessário como fonte. | §1, §2                        | nenhuma — pendência resolvida                    |
