...
proveniencia:
  ...
  notas: O enum legado não representa fielmente totalidade da remuneração proporcional ao tempo; ausência de informação não equivale a causa comum. Origem material: substituição.
decisoes:
- data: 2026-08-01
  quem: franklinbaldo
...
Hipótese residual proporcional sob EC 20/1998. A fórmula jurídica é conhecida, mas a projeção fiel ainda exige forma de cálculo parametrizável no Sisprev.
