...
id: regra-0005
row_index: 5
nome: Pensão por Morte (CF/88 Art. 40, § 7º - EC 20/1998)
...
# Pensão por Morte (CF/88 Art. 40, § 7º - EC 20/1998)
...
- Autenticação documental da certidão de óbito do instituidor.
- Validação probatória da qualidade jurídica de dependente habilitado à data do óbito.
- Verificação de não-cumulação indevida de benefícios previdenciários.
